...
//
// DESCRIPTION
// TODO. Creates a Main object containing main logic for program
//
...
public class Main {
    ...
    private void run() {
         ...
         *
         * PSEUDOCODE Declare ArrayList<Student> object named studentList and initialize
         * it to null
         *
         ...
         * cannot open the input file for -- reading, then we output an error message
         * and terminate the program. try studentList = readFile() catch
         * (FileNotFoundException) Print "Sorry, could not open 'p02-students.txt' for
         * reading. Stopping." Call System.exit(-1) end try-catch
         *
         ...
         * identifier -- Note that Sorter.insertionSort() is a static/class method so we
         * do not have to instantiate -- an object of the Sorter class, we just write
         * class-name.static-method-name() to call a -- static method in a class. Call
         * Sorter.insertionSort(studentList, Sorter.SORT_ASCENDING) to sort the list
         *
         * -- In the try-catch block we try to write the list of students and their
         * calculated tuitions -- to p02-tuition.txt If we cannot open the output file
         * for writing, then we output an error -- message and terminate the program.
         * try writeFile(studentList) catch (FileNotFoundException) Print "Sorry, could
         * not open 'p02-tuition.txt' for writing. Stopping." Call System.exit(-1) end
         * try-catch
         * 
         * 
         * 
         * 
         * Get students from p02-students.txt
    ...
    private void calcTuition(ArrayList<Student> pStudentList) {
        /**
         * Calculates the tuition for each Student in pStudentList. Write an enhanced
         * for loop that iterates over each Student in pStudentList. For each Student,
         * call calcTuition() on that Student object. Note: this is a polymorphic method
         * call. What does that mean?
         *
         * PSEUDOCODE Enhanced ForEach student in pStudentList Do student.calcTuition()
    ...
    private ArrayList<Student> readFile() throws FileNotFoundException {
         ...
         *
         * PSEUDOCODE Declare and create an ArrayList<Student> object named studentList
         * Open "p02-students.txt" for reading using a Scanner object named in While
         * in.hasNext() returns true Do String studentType <= read next string from in
         * If studentType is "C" Then studentList.add(readOnCampusStudent(in)) Else
    ...
    private void writeFile(ArrayList<Student> pStudentList) throws FileNotFoundException {
         ...
         * Using out.printf() output the student information per SW Requiremment 3 End
